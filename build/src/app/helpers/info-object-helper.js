...
exports.metersToMiles = exports.setYelpRatingImage = void 0;
function setYelpRatingImage(rating) {
    let rating_image;
    if (rating === 0) {
...
exports.setYelpRatingImage = setYelpRatingImage;
function metersToMiles(m) {
    const miles = 0.00062137 * m;
    const miles_fixed = miles.toPrecision(2);
    return miles_fixed;
}
exports.metersToMiles = metersToMiles;
//# sourceMappingURL=info-object-helper.js.map